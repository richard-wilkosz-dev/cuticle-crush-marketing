...
export const Products = () => {
  return (
    <Blog className="bg-secondary" sectionId="products" title="Products">
      <p>
      ...
      <p>
        ...
        often 30+ days on toes. It is also 9-free.
      </p>
      <p>
        Light Elegance and Stellar Gel (HEMA/TPO/HPMA free) are the main gel
        systems I use. Both are formulated to be as hypoallergenic as possible,
        and although many with gel allergies have used these products without a
        reaction, it is not a guarantee.
      </p>
      <p>
