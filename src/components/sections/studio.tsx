...
export const Studio = () => {
  return (
    <Blog sectionId="studio" title="Studio">
      <p>
      ...
      <p>
        ...
        pop in your earbuds to listen to your audiobook solo. My studio address
        is automatically sent in a confirmation text 24hrs before your
        appointment.
      </p>
    </Blog>
  );
